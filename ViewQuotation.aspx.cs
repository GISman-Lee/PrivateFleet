...
public partial class ViewQuotation : System.Web.UI.Page
{
    ...
    string Fdate, Tdate, Make, Model, Trans, State;
    int RowCnt = 0, cnt = 0;
    ...
    protected void btnBack_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else if (Convert.ToString(Request.QueryString["chk"]) == "fromAdminCQR")
        {
            ...
            Response.Redirect("CompletedQuoatationReport.aspx?Fdate=" + Fdate + "&Tdate=" + Tdate + "&Make=" + Make + "&Model=" + Model + "&Trans=" + Trans + "&State=" + State + "&Sorton=" + Sorton + "&SortOrder=" + SortOrder);
        }
        else
