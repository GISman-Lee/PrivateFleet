<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VDT_AutomaticMailReport.aspx.cs" Inherits="VDT_AutomaticMailReport" %>
...
<uc1:UC_VDT_AutomaticMailReport  runat="server" id="UC_VDTAutomaticMail" Visible ="false"></uc1:UC_VDT_AutomaticMailReport>
<uc1:UC_VDT_DealerRespone runat ="server" ID ="ucDealerResponse" Visible ="false" />
<uc1:UC_VDTCustomer runat ="server" ID ="UC_VDT_Customer" Visible ="false" />
