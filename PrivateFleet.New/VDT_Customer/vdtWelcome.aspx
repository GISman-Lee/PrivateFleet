<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vdtWelcome.aspx.cs" Inherits="VDT_Customer_Welcome" %>
...
<body>
        ...
        <ContentTemplate>
                                                    ...
                                                    <td align="center" colspan="2" valign="middle">
                                                        <div align="center" style="vertical-align: middle; width: 100%; min-height: 400px">
                                                            <table width="100%" cellspacing="5" style="padding-left: 100px; padding-right: 100px;">
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="width: 12%; padding-left: 10px; font-weight: bold">
                                                                        Dealer Name :
                                                                    </td>
                                                                    <td style="width: 14%;">
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="width: 10%; padding-left: 10px; font-weight: bold" colspan="4">
                                                                        Stock Number -&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <asp:Label runat="server" ID="lblStockNo" Font-Bold="false"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="4">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    Private Fleet directly and we will follow up with the dealer.--%>
                                                                            The supplying dealer has committed to give delivery updates on a frequent basis.
                                                                            The latest update is recorded above however if you require a further update, please
                                                                            either contact the dealer directly using the details above or click the button below.
                                                                            If you have any problems getting a response, please contact Private Fleet directly
                                                                            and we will follow up with the dealer.
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
            ...
            <div id="msgpop" runat="server" style="display: none; width: 400px;">
                ...
                <div id="processMessage1" style="width: 400px; height: auto; padding: 5px !important;">
                    ...
                    <asp:Panel runat="server" ID="pnlClientReq" BackColor="White" Visible="true">
                        <table width="400px" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="background-color: #0A73A2; color: White; font-weight: bold; padding-left: 5px;
                                    height: 30px; font-size: large">
                            ...
                            <tr>
                                <td style="padding-left: 5px">
                                    <asp:TextBox runat="server" ID="txtEmailMsg" TextMode="MultiLine" Width="390px" Height="180px"
                                        Text="Please can you give me the latest update on my car delivery."></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtEmailMsg"
                                        ErrorMessage="Enter Message" Display="None" ValidationGroup="send"></asp:RequiredFieldValidator>
                                    <ajaxToolkit:ValidatorCalloutExtender runat="server" ID="ValidatorCalloutExtender1"
                                        TargetControlID="requiredtxtDesc">
                                    </ajaxToolkit:ValidatorCalloutExtender>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:ImageButton ID="imgbtnClientReq" runat="server" Text="Send" OnClick="imgbtnClientReq_Click"
                                        ImageUrl="~/Images/send_mail_hvr.gif" onmouseout="this.src='../Images/send_mail_hvr.gif'"
                                        onmouseover="this.src='../Images/send_mail.gif'" ValidationGroup="send" />
                                    <asp:ImageButton ID="imgbtnCancel" runat="server" Text="Cancel" OnClick="imgbtnCancel_Click"
                                        ImageUrl="~/Images/Cancel.gif" onmouseout="this.src='../Images/Cancel.gif'" onmouseover="this.src='../Images/Cancel_hvr.gif'" />
                                </td>
                            </tr>
                            <tr>
    ...
    <asp:UpdateProgress ID="upProcess" runat="server" DisplayAfter="0" AssociatedUpdatePanelID="Up1">
        <ProgressTemplate>
            <div id="progressBackgroundFilter">
            </div>
