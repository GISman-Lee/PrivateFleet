<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Uc_VDT_CustomerHelpStausRpt.ascx.cs"
    Inherits="User_Controls_Uc_VDT_CustomerHelpStausRpt" %>
<style type="text/css">
    .style1
    {
    }
        ...
        <tr>
            <td align="center">
                <table width="100%" cellpadding="0px" cellspacing="5px">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ajaxToolkit:CalendarExtender runat="server" ID="ajxFromDateCalender" TargetControlID="txtFromDate">
                                        ...
                                        <asp:RegularExpressionValidator runat="server" ID="regExpreFromDate" Display="None"
                                        ...
                                        <ajaxToolkit:ValidatorCalloutExtender runat="server" ID="valFromDate" TargetControlID="regExpreFromDate"
                                    ...
                                    <td>
                                        ...
                                        <ajaxToolkit:CalendarExtender runat="server" ID="ajxTodateCalender" TargetControlID="txtToDate">
                                        </ajaxToolkit:CalendarExtender>
                    ...
                    <tr>
                        <td>
                            <asp:GridView runat="server" ID="grdAdminHelpCustomerRpt" Width="100%" AutoGenerateColumns="false"
                                AllowPaging="true" AllowSorting="true" OnPageIndexChanging="grdAdminHelp_PageIndexChanging"
                                RowStyle-HorizontalAlign="Left" OnSorting="grdAdminHelp_Sorting" EmptyDataText="No Recrods Found."
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Dealer Name" SortExpression="DealerName" ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblDealerName" Text='<%# bind("DealerName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Description" SortExpression="Description" ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Requested Date" SortExpression="CustomerRequestedDate"
                                        ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblCustomerRequestedDate" Text='<%# bind("CustomerRequestedDate","{0: dd MMM yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Dealer Status Updated Date" SortExpression="DealerStatusUpdatedDate"
                                        ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblDealerStatusUpdatedDate" Text='<%# bind("DealerStatusUpdatedDate","{0: dd MMM yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Status" SortExpression="Status" ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
