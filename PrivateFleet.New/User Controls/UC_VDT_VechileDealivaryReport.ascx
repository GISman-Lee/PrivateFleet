<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_VDT_VechileDealivaryReport.ascx.cs"
    Inherits="User_Controls_UC_VDT_VechileDealivaryReport" %>
<table width="100%">
    <tr>
        <td align="center">
            <table>
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="requiredMake" ControlToValidate="drpMake"
                            ErrorMessage="Select Make." InitialValue="0" Display="None" ValidationGroup="vechicle"></asp:RequiredFieldValidator>
        ...
        <td>
            <asp:GridView runat="server" ID="grdVechileDelivaryReport" Width="100%" EmptyDataText="No Records Found."
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle"
                        ItemStyle-CssClass="grid_padding" ItemStyle-Width="20%" HeaderText="Delivered"
                        SortExpression="ETA">
                        <ItemTemplate>
