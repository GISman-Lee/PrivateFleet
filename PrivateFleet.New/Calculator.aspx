<%@ Page Title="Calculator" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function clicklink() {
            window.open('http://www.greenvehicleguide.gov.au/GVGPublicUI/home.aspx', '_blank');
        }
    </script>
    ...
    <table align="center" width="95%" cellpadding="2" cellspacing="2">
        ...
        <tr>
            ...
            <td colspan="2">
                <strong id="hlink" runat="server" visible="false" style="text-decoration: none; font-size: 8pt;
                    cursor: default;"><a onclick="clicklink()">http://www.greenvehicleguide.gov.au/GVGPublicUI/home.aspx
                    </a></strong>
            </td>
        </tr>
    </table>
