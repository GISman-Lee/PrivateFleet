<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="QuoteRequest.aspx.cs" Inherits="QuoteRequest" Title="Create Quote Request" %>

<%@ Register Src="User Controls/Request/ucRequestParameters.ascx" TagName="ucRequestParameters"
    TagPrefix="uc5" %>
<%--<%@ Register Src="User Controls/Request/ucAdditionalAccessories.ascx" TagName="ucAdditionalAccessories"
    TagPrefix="uc3" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function hideDiv() {
            var msgpop = document.getElementById('ctl00_ContentPlaceHolder1_msgpop');
                            ...
                            <table width="98%" align="center" border="0" cellpadding="0" cellspacing="1">
                                <tr>
                                    <td valign="middle">
                                        ...
                                        <img id="imgtest" runat="server" src="~/Report/Report.pdf" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 100%;">
                                ...
                                <tr>
                                    <td align="right">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:ImageButton ID="imagebtnSaveAt1" runat="server" Text="Save" ImageUrl="~/Images/save_d.gif"
                                            ImageAlign="AbsMiddle" onmouseout="this.src='Images/save_d.gif'" onmouseover="this.src='Images/save_u.gif'"
                                            OnClick="imagebtnSaveAt1_Click" ValidationGroup="VGMakeModelSeries" />
                                        <asp:ImageButton ID="imgbtnCancelQR" runat="server" AlternateText="Cancel QR" ImageUrl="~/Images/cancelQuote_d.png"
                                            Visible="false" ImageAlign="AbsMiddle" onmouseout="this.src='Images/cancelQuote_d.png'"
                                            onmouseover="this.src='Images/cancelQuote_u.png'" OnClick="imgbtnCancelQR_Click" />
                                        ...
                                        <asp:ImageButton ID="imgbnTemp" Visible="false" runat="server" AlternateText="Temp"
                    ...
                    <asp:View ID="viewDealerSelection" runat="server">
                        <table width="95%" align="center" style="border: 1px solid #4A4A4A" cellpadding="1"
                            ...
                            <tr>
                                ...
                                <td style="height: 5px">
                                    <asp:TextBox ID="txtPCode" MaxLength="6" runat="server" AutoPostBack="true" OnTextChanged="txtPCode_TextChanged">
                                    </asp:TextBox>
                                    <%--    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="None"
                        ...
                        <table width="95%" align="center" style="border: 1px solid #4A4A4A" cellpadding="1"
                            ...
                            <tr>
                                <td colspan="3" class="subheading">
                                    <b>Send Quote Request Templete to Customer.</b>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="imgbtnSendCustomerMail" runat="server" ImageUrl="~/Images/SendSaveQR_u.gif"
                                        onmouseout="this.src='Images/SendSaveQR_u.gif'" onmouseover="this.src='Images/SendSaveQR_d.gif'"
                        ...
                        <table width="95%" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" width="60%" style="height: 20px">
                                    <asp:ImageButton ID="imgbtnSaveAt2" runat="server" Text="Save" ImageUrl="~/Images/save_d1.jpg"
                                        ImageAlign="AbsMiddle" onmouseout="this.src='Images/save_d1.jpg'" onmuseover="this.src='Images/save_u1.jpg'"
                                        OnClick="imgbtnSaveAt2_Click" Style="float: left;" ValidationGroup="Create" />
                                    <asp:ImageButton ID="imgbtnCancelQRAt2" Style="float: left; margin-left: 5px;" runat="server"
                                        AlternateText="Cancel QR" ImageUrl="~/Images/cancelQuote1_d.gif" ImageAlign="AbsMiddle"
                                        onmouseout="this.src='Images/cancelQuote1_d.gif'" onmouseover="this.src='Images/cancelQuote1_u.gif'"
                                        OnClick="imgbtnCancelQR_Click" />
                                    <asp:ImageButton ID="btnCreateRequest" runat="server" Style="float: left; margin-left: 5px;"
                                        OnClick="btnCreateRequest_Click" ImageUrl="~/Images/Create_request.gif" onmouseout="this.src='Images/Create_request.gif'"
                        ...
                        <table width="100%">
                            ...
                            <tr style="padding: 10px">
                                ...
                                <td align="left" valign="top" width="60%" style="height: 20px">
                                    ...
                                    <asp:ImageButton ID="imgbtnCancelAt3" runat="server" AlternateText="Cancel QR" ImageUrl="~/Images/cancelQuote_d.png"
                                        ImageAlign="AbsMiddle" onmouseout="this.src='Images/cancelQuote_d.png'" onmouseover="this.src='Images/cancelQuote_u.png'"
                                        OnClick="imgbtnCancelQR_Click" />
    ...
    <!-- Added to display save confirmation -->
                ...
                <table width="300px" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="padding-left: 5px" align="center">
                            <p>
                                <asp:Label runat="server" ID="lblMessageForModal" Text="Quote Request Saved Successfully."></asp:Label>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" id="tdButtons" runat="server" visible="false">
    ...
    <!-- end -->
    <asp:UpdateProgress ID="upProcess" runat="server" DisplayAfter="0" AssociatedUpdatePanelID="UPQuoteRequest">
        <ProgressTemplate>
