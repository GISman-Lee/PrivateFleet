        ...
        try
        {
            ...
            switch (Convert.ToInt32(hdfStateID.Value))
            {
                ...
                case 1:
                    ...
                    //Commented By :Ayyaj Change Theshold Value 59133 to 60316
                    ...
                    //Commented By :Ayyaj on 01 July 2014 Change Theshold Value 60316 to 61884
                    //AmounttoInvoice = (PurchasePrice > 60316) ? Difference / 1.35 : (PurchasePrice < 60316 && PurchasePrice > 45000) ? Difference / 1.05 : Difference / 1.03;
                    AmounttoInvoice = (PurchasePrice > 61884) ? Difference / 1.35 : (PurchasePrice < 61884 && PurchasePrice > 45000) ? Difference / 1.05 : Difference / 1.03;
                    break;
                ...
                case 3:
                    ...
                    //Commented By :Ayyaj Change Threshold Value 59133 to 60316
                    //AmounttoInvoice = (PurchasePrice > 59133) ? Difference / 1.3 : Difference;
                    //Commented By :Ayyaj on 01 July 2014 Change Theshold Value 60316 to 61884
                    //AmounttoInvoice = (PurchasePrice > 60316) ? Difference / 1.3 : Difference;
                    AmounttoInvoice = (PurchasePrice > 61884) ? Difference / 1.3 : Difference;
                    break;

                //For VIC
                case 4:
                    //Commented By :Ayyaj Change Threshold Value 57000 to 60316
                    //StampDutyPayable = (PurchasePrice > 57000) ? PurchasePrice * 0.05 : PurchasePrice * 0.03;
                    //Commented By :Ayyaj on 01 July 2014 Change Theshold Value 60316 to 61884
                    //StampDutyPayable = (PurchasePrice > 60316) ? PurchasePrice * 0.05 : PurchasePrice * 0.03;
                    StampDutyPayable = (PurchasePrice > 61884) ? PurchasePrice * 0.05 : PurchasePrice * 0.03;
                    //Commented By :Ayyaj Change Threshold Value 59133 to 60316
                    //AmounttoInvoice = (PurchasePrice > 59133) ? Difference / 1.35 : Difference / 1.03;
                    //Commented By :Ayyaj on 01 July 2014 Change Theshold Value 60316 to 61884
                    //AmounttoInvoice = (PurchasePrice > 60316) ? Difference / 1.35 : Difference / 1.03;
                    AmounttoInvoice = (PurchasePrice > 61884) ? Difference / 1.35 : Difference / 1.03;
                    break;
                ...
                case 8:
                    ...
                    //Commented By :Ayyaj on 01 July 2014 Change Theshold Value 60316 to 61884
                    //AmounttoInvoice = (PurchasePrice > 60316) ? Difference / 1.34 : (PurchasePrice < 35000) ? Difference / 1.03 : (PurchasePrice > 41000) ? Difference / 1.04 : -1;
                    AmounttoInvoice = (PurchasePrice > 61884) ? Difference / 1.34 : (PurchasePrice < 35000) ? Difference / 1.03 : (PurchasePrice > 41000) ? Difference / 1.04 : -1;
                    break;
            }

            //LuxuryCarTax formula is same for all State
            //change on 2 july 2013 From 59133 to 60316.00
            //Changed By :Ayyaj on 01 July 2014 Change Theshold Value 60316 to 61884
            LuxuryCarTax = (PurchasePrice > 61884) ? (PurchasePrice - 61884) * 0.33 / 1.1 : 0;
