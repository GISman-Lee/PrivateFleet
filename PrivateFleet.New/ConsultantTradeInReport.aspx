<%@ Page Title="Trade In Report" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="ConsultantTradeInReport.aspx.cs" Inherits="ConsultantTradeInReport"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdfTradeInType" runat="server" Value='<%# Bind("TradeInType") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <FooterStyle CssClass="gvFooterrow" />
