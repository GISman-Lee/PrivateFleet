<%@ Page Title="User Master" Language="C#" AutoEventWireup="true" CodeFile="UserMaster_2.aspx.cs" Inherits="UserMaster_2" %>
            ...
            <ContentTemplate>--%>
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:TextBox ID="txtPhone" runat="server" Width="170px"></asp:TextBox>
                        </td>
                        <td valign="top">
                            &nbsp;&nbsp;Address :
                        </td>
