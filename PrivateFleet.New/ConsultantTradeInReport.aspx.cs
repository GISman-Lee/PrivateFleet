...
public partial class ConsultantTradeInReport : System.Web.UI.Page
{
    ...
    private void DataBind1()
    {
        if (ViewState["gvTInReport"] == null)
            dt = objReport.GetReportForTradeIn1_2();
        else
    ...
    protected void gvTInReport_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ViewDetails")
        {
            ...
            //Addded By : Ayyaj On 17 Oct 2014
            string Tradein = Convert.ToString(((HiddenField)gvRow.FindControl("hdfTradeInType")).Value);
            ...
            //Addded By : Ayyaj On 17 Oct 2014
            ((HiddenField)ucTradeInData1.FindControl("hdfTradeIn")).Value = Convert.ToString(Tradein);
            ...
            //end 
            //Modified By: Ayyaj On 14 May 2014
            ((Label)ucTradeInData1.FindControl("lblSurname_t")).Text = "<span style='color:Black; font-size:13px; font-weight:normal;'>Name:</span>&nbsp;" + Convert.ToString(dtDerails.Rows[0]["Name"]);
            if (!string.IsNullOrEmpty(Convert.ToString(dtDerails.Rows[0]["Email"])))
            {
                ((Label)ucTradeInData1.FindControl("lblClientEmail_t")).Text = "<span style='color:Black; font-size:13px; font-weight:normal;'>Email:</span>&nbsp;" + Convert.ToString(dtDerails.Rows[0]["Email"]);
            }
            else
            {
                ((Label)ucTradeInData1.FindControl("lblClientEmail_t")).Text = "<span style='color:Black; font-size:13px; font-weight:normal;'>Email:</span>&nbsp;---";
            }

            if (!string.IsNullOrEmpty(Convert.ToString(dtDerails.Rows[0]["Mobile"])))
            {
                ((Label)ucTradeInData1.FindControl("lblClientNo_t")).Text = "<span style='color:Black; font-size:13px; font-weight:normal;'>Mobile:</span>&nbsp;" + Convert.ToString(dtDerails.Rows[0]["Mobile"]);
            }
            else
            {
                ((Label)ucTradeInData1.FindControl("lblClientNo_t")).Text = "<span style='color:Black; font-size:13px; font-weight:normal;'>Mobile:</span>&nbsp;---";
            }

            if (!string.IsNullOrEmpty(Convert.ToString(dtDerails.Rows[0]["Consultant"])))
            {
                ((Label)ucTradeInData1.FindControl("lblCunsultant_t")).Text = "<span style='color:Black; font-size:13px; font-weight:normal;'>Consultant:</span>&nbsp;" + Convert.ToString(dtDerails.Rows[0]["Consultant"]);
            }
            else
            {
                ((Label)ucTradeInData1.FindControl("lblCunsultant_t")).Text = "<span style='color:Black; font-size:13px; font-weight:normal;'>Consultant:</span>&nbsp;---";
            }
