...
public class Cls_VDTWelcome
{
    ...
    public void SendUpdateRequestTODealer(DataTable dt)
    {
        try
        {
            ...
            message = message + "<p style='font: normal normal normal 16px Calibri; color:#1F497D;'>" + strCustomerSerRespName + "<br>Customer Service Manager<br>Private Fleet<br>Lvl 2, 845 Pacific Hwy<br>Chatswood NSW 2067<br>1300 303 181</p>";
            Message = message;
