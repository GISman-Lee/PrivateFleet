...
public class Cls_Login
{
    ...
    public void sendMail_SecondResponse(DataTable dt, String DealerIDs)
    {
        ...
        try
        {
            ...
            message = message + "<p style='font: normal normal normal 16px Calibri; color:#1F497D;'> Many thanks<br /> <span style='color: #000080; font-family: Book Antiqua; font-size: 12pt; font-weight: bold;'>Catherine Heyes<br /> Sales Coordinator<br /> Private Fleet - Car Buying Made Easy</span><br />";
