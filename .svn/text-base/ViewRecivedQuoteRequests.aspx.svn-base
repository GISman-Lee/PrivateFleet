<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewRecivedQuoteRequests.aspx.cs" Inherits="ViewRecivedQuoteRequests"
    Title="View Received Quote Requests" %>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvMakeDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        OnRowDataBound="gvMakeDetails_RowDataBound" OnRowEditing="gvMakeDetails_RowEditing"
                        OnRowUpdating="gvMakeDetails_RowUpdating" Width="100%" DataKeyNames="ID" AllowSorting="True"
                        OnSorting="gv_Sorting" PageSize="15" EmptyDataText="No record to display">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkCreateQuotation" runat="server" CommandName="CreateQuote"
                                        Text="Create Quotation" CssClass="activeLink"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteQuote" Text="Ignore Quotation"
                                        CssClass="activeLink"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
