<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_VDTCustomerReport_PC.ascx.cs"
    Inherits="VDT_Customer_User_Controls_UC_VDTCustomerReport_PC" %>
            ...
            <td align="center">
                <table cellpadding="5px" cellspacing="2px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList runat="server" ID="ddlPrimaryContact" Width="155px">
                            </asp:DropDownList>
                        </td>
                        <td>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="grdCustomer" runat="server" AllowPaging="true" AllowSorting="true"
                                ...
                                RowStyle-HorizontalAlign="Left" OnSorting="grdCustomer_Sorting" RowStyle-Height="30px"
                                Width="100%">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Primary Contact" SortExpression="PrimaryContact" ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPrimaryContact" runat="server" Text='<%# bind("PrimaryContact") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Company" SortExpression="Company" ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Status" ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                            <asp:HyperLink runat="server" ID="hypcustomerlinkview" Text="Update" CssClass="activeLink"
                                                NavigateUrl='<%# bind("id") %>'></asp:HyperLink>
                                            <asp:LinkButton ID="lnkbtnView" runat="server" AlternateText="View" Visible="false"
                                                CommandArgument='<%# bind("dealeremail") %>' CommandName="show" CssClass="activeLink"
                                                Text="View" />
                                            <asp:HiddenField ID="hiddencustomerid" runat="server" Value='<%# bind("id") %>' />
                                            <asp:HiddenField ID="hdnIsActiveCustomer" runat="server" Value='<%# bind("IsActive") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-CssClass="grid_padding">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkUnmark" Enabled="false" CssClass="deactiveLink"  runat="server" AlternateText="Unmark" CommandArgument='<%# bind("dealeremail") %>'
                                                CommandName="Unmark"  Text="Unmark" />
                                            <asp:HiddenField ID="hdfUnmark" runat="server" Value='<%# bind("Unmark") %>' />
