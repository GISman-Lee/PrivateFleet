...
<asp:UpdatePanel ID="upnlTradeInDate" runat="server">
    <ContentTemplate>
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="center" id="tdHeader1" runat="server" style="color: Red; font-size: 18px;
            ...
            <tr id="trRemoveTradeIn" runat="server" visible="false" align="center">
                <td>
                    ...
                    <asp:ImageButton ID="btnRemove" runat="server" ImageUrl="~/Images/Remove.gif" onmouseout="this.src='Images/Remove.gif'"
