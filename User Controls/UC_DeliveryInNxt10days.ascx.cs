...
public partial class User_Controls_UC_DeliveryInNxt10days : System.Web.UI.UserControl
{
    #region Private Variables
    ILog logger = LogManager.GetLogger(typeof(User_Controls_UC_DeliveryInNxt10days));
    DataTable dt = null;
    #endregion
    ...
    private void BindData()
    {
        ...
        try
        {
            ...
            {
                dtData = objDealerRpt.GetDeliveryReportinNxt10Days(strContactName,10);
            }
            else
            {
